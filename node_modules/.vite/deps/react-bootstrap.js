...
import {
  ...
  getSharedManager,
  useWillUnmount
} from "./chunk-SCJVBFHY.js";
import {
  dataAttr,
  dataProp,
  qsa
} from "./chunk-SSBXURA7.js";
import {
  Overlay_default,
  PopoverBody_default,
  ...
  Popover_default,
  Tooltip_default
} from "./chunk-PQ6ARWOV.js";
import "./chunk-PICG6AJN.js";
import {
  require_warning
...
var Carousel = React32.forwardRef(({
  ...
  return (0, import_jsx_runtime31.jsxs)(Component, {
    ref: elementRef,
    ...props,
...
var TabContext = React41.createContext(null);
...
var NavItem = React42.forwardRef((_ref, ref) => {
  let {
...
var Nav = React43.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component = "div",
    onSelect,
...
var NavItem2 = React46.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react17.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react18.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React52.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var OffcanvasTitle = React55.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React56.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react19.useCallback)((backdropProps) => (0, import_jsx_runtime56.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React57.forwardRef((props, ref) => {
...
var NavbarText = React58.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var Navbar = React59.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
...
var NavDropdown = React60.forwardRef(({
  ...
  return (0, import_jsx_runtime63.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames51.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime62.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime66.jsxs)(import_jsx_runtime65.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react22.cloneElement)(children, triggerProps), (0, import_jsx_runtime64.jsx)(Overlay_default, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React62.forwardRef(({
  ...
  return (0, import_jsx_runtime67.jsx)("li", {
    ...
    children: (0, import_jsx_runtime68.jsxs)(Component, {
...
var Placeholder = React65.forwardRef(({
  ...
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime71.jsx)(Component, {
    ...placeholderProps,
    ref
  });
});
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react24.useContext)(TabContext_default);
  if (!context4)
    ...
    return (0, import_jsx_runtime79.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime79.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime79.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime79.jsx)(Component, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
  ...
  return (0, import_jsx_runtime83.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime83.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime83.jsx)(Transition, {
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime83.jsx)(Component, {
          ...rest,
          ref,
