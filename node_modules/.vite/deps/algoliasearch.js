    ...
    !function(t, e) {
      ...
      function i(t2) {
        var e2, r2 = "algoliasearch-client-js-".concat(t2.key), n2 = function() {
          ...
          n2().setItem(r2, JSON.stringify(t3));
        }, u2 = function() {
          var e3 = t2.timeToLive ? 1e3 * t2.timeToLive : null, r3 = o2(), n3 = Object.fromEntries(Object.entries(r3).filter(function(t3) {
            return void 0 !== a(t3, 2)[1].timestamp;
          }));
          if (i2(n3), e3) {
            var u3 = Object.fromEntries(Object.entries(n3).filter(function(t3) {
              var r4 = a(t3, 2)[1], n4 = (/* @__PURE__ */ new Date()).getTime();
              return !(r4.timestamp + e3 < n4);
            }));
            i2(u3);
          }
        };
        return { get: function(t3, e3) {
          ...
          return Promise.resolve().then(function() {
            u2();
            var e4 = JSON.stringify(t3);
            return o2()[e4];
          }).then(function(t4) {
            return Promise.all([t4 ? t4.value : e3(), void 0 !== t4]);
          }).then(function(t4) {
          ...
          return Promise.resolve().then(function() {
            var a2 = o2();
            return a2[JSON.stringify(t3)] = { timestamp: (/* @__PURE__ */ new Date()).getTime(), value: e3 }, n2().setItem(r2, JSON.stringify(a2)), e3;
          });
        }, delete: function(t3) {
          return Promise.resolve().then(function() {
            var e3 = o2();
      ...
      function k(t2, e2, n2, a2) {
        ...
        }(t2, a2), c2 = n2.method, f2 = n2.method !== x ? {} : r(r({}, n2.data), a2.data), d2 = r(r(r({ "x-algolia-agent": t2.userAgent.value }, t2.queryParameters), f2), a2.queryParameters), l2 = 0, h2 = function e3(r2, o2) {
          var f3 = r2.pop();
          if (void 0 === f3)
            throw { name: "RetryError", message: "Unreachable hosts - your application id may be incorrect. If the error persists, contact support@algolia.com.", transporterStackTrace: E(i2) };
          var h3 = { data: u2, headers: s2, method: c2, url: N(f3, n2.path, d2), connectTimeout: o2(l2, t2.timeouts.connect), responseTimeout: o2(l2, a2.timeout) }, p2 = function(t3) {
            var e4 = { request: h3, response: t3, host: f3, triesLeft: r2.length };
            ...
            var a3 = p2(n3);
            return n3.isTimedOut && l2++, Promise.all([t2.logger.info("Retryable failure", A(a3)), t2.hostsCache.set(f3, O(f3, n3.isTimedOut ? P : b))]).then(function() {
              return e3(r2, o2);
            });
          }, onFail: function(t3) {
            throw p2(t3), function(t4, e4) {
              var r3 = t4.content, n3 = t4.status, a3 = r3;
              try {
                a3 = JSON.parse(r3).message;
              } catch (t5) {
              }
              return /* @__PURE__ */ function(t5, e5, r4) {
                return { name: "ApiError", message: t5, status: e5, transporterStackTrace: r4 };
              }(a3, n3, e4);
            }(t3, E(i2));
          } };
          return t2.requester.send(h3).then(function(t3) {
        ...
        return q(t2.hostsCache, e2).then(function(t3) {
          return h2(o(t3.statelessHosts).reverse(), t3.getTimeout);
        });
      }
      function S(t2) {
        var e2 = t2.hostsCache, r2 = t2.logger, n2 = t2.requester, o2 = t2.requestsCache, i2 = t2.responsesCache, u2 = t2.timeouts, s2 = t2.userAgent, c2 = t2.hosts, f2 = t2.queryParameters, d2 = { hostsCache: e2, logger: r2, requester: n2, requestsCache: o2, responsesCache: i2, timeouts: u2, userAgent: s2, headers: t2.headers, queryParameters: f2, hosts: c2.map(function(t3) {
          ...
          var r3 = y(e3, d2.timeouts.read), n3 = function() {
            return k(d2, d2.hosts.filter(function(t4) {
      ...
      function N(t2, e2, r2) {
        var n2 = R(r2), a2 = "".concat(t2.protocol, "://").concat(t2.url, "/").concat("/" === e2.charAt(0) ? e2.substr(1) : e2);
        return n2.length && (a2 += "?".concat(n2)), a2;
      }
      function R(t2) {
        return Object.keys(t2).map(function(e2) {
          return p("%s=%s", e2, (r2 = t2[e2], "[object Object]" === Object.prototype.toString.call(r2) || "[object Array]" === Object.prototype.toString.call(r2) ? JSON.stringify(t2[e2]) : t2[e2]));
          var r2;
        }).join("&");
      }
      function E(t2) {
      ...
      var C = function(t2) {
        ...
        return function(e2, r2) {
          return t2.transporter.write({ method: I, path: p("2/abtests/%s", e2) }, r2);
        };
      }, z = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: x, path: p("2/abtests/%s", e2) }, r2);
        };
      }, J = function(t2) {
        return function(e2) {
        ...
        return function(e2, r2) {
          return t2.transporter.write({ method: j, path: p("2/abtests/%s/stop", e2) }, r2);
        };
      }, H = function(t2) {
        return function(e2) {
      ...
      var K = function(t2) {
        ...
        return function(e2, r2) {
          return d(t2.transporter.write({ method: j, path: p("/1/dictionaries/%s/batch", e2), data: { clearExistingDictionaryEntries: true, requests: { action: "addEntry", body: [] } } }, r2), function(e3, r3) {
            return jt(t2)(e3.taskID, r3);
          });
        };
      }, G = function(t2) {
        return function(e2, r2, n2) {
          return d(t2.transporter.write({ method: j, path: p("1/indexes/%s/operation", e2), data: { operation: "copy", destination: r2 } }, n2), function(r3, n3) {
            return ut(t2)(e2, { methods: { waitTask: de } }).waitTask(r3.taskID, n3);
          });
        };
      }, V = function(t2) {
        return function(e2, n2, a2) {
          return G(t2)(e2, n2, r(r({}, a2), {}, { scope: [he.Rules] }));
        };
      }, _ = function(t2) {
        return function(e2, n2, a2) {
          return G(t2)(e2, n2, r(r({}, a2), {}, { scope: [he.Settings] }));
        };
      }, X = function(t2) {
        return function(e2, n2, a2) {
          return G(t2)(e2, n2, r(r({}, a2), {}, { scope: [he.Synonyms] }));
        };
      }, Y = function(t2) {
        return function(e2, r2) {
        ...
        return function(e2, r2) {
          return d(t2.transporter.write({ method: I, path: p("1/keys/%s", e2) }, r2), function(r3, n2) {
        ...
        return function(e2, r2, n2) {
          ...
          return d(t2.transporter.write({ method: j, path: p("/1/dictionaries/%s/batch", e2), data: { clearExistingDictionaryEntries: false, requests: a2 } }, n2), function(e3, r3) {
            return jt(t2)(e3.taskID, r3);
          });
        };
      }, tt = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: x, path: p("1/keys/%s", e2) }, r2);
        };
      }, et = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: x, path: p("1/task/%s", e2.toString()) }, r2);
        };
      }, rt = function(t2) {
        return function(e2) {
        ...
        return function(e2, r2) {
          return t2.transporter.read({ method: x, path: p("1/clusters/mapping/%s", e2) }, r2);
        };
      }, it = function(t2) {
        return function(e2) {
        ...
        return function(e2, r2, n2) {
          return d(t2.transporter.write({ method: j, path: p("1/indexes/%s/operation", e2), data: { operation: "move", destination: r2 } }, n2), function(r3, n3) {
            return ut(t2)(e2, { methods: { waitTask: de } }).waitTask(r3.taskID, n3);
          });
        };
      }, ht = function(t2) {
        ...
        return function(e2, n2) {
          var a2 = e2.map(function(t3) {
            return r(r({}, t3), {}, { params: R(t3.params || {}) });
          });
        ...
        return function(e2, r2, n2) {
          ...
          return d(t2.transporter.write({ method: j, path: p("/1/dictionaries/%s/batch", e2), data: { clearExistingDictionaryEntries: true, requests: a2 } }, n2), function(e3, r3) {
            return jt(t2)(e3.taskID, r3);
          });
        };
      }, bt = function(t2) {
        return function(e2, r2) {
          return d(t2.transporter.write({ method: j, path: p("1/keys/%s/restore", e2) }, r2), function(r3, n2) {
            return f(function(r4) {
        ...
        return function(e2, r2, n2) {
          return t2.transporter.read({ method: j, path: p("/1/dictionaries/%s/search", e2), data: { query: r2 }, cacheable: true }, n2);
        };
      }, wt = function(t2) {
        return function(e2, r2) {
        ...
        return function(e2, r2) {
          ...
          return d(t2.transporter.write({ method: D, path: p("1/keys/%s", e2), data: s2 }, u2), function(r3, n2) {
            return f(function(r4) {
        ...
        return function(e2, r2) {
          return d(t2.transporter.write({ method: j, path: p("1/indexes/%s/batch", t2.indexName), data: { requests: e2 } }, r2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, qt = function(t2) {
        return function(e2) {
          return B(r(r({ shouldStop: function(t3) {
            return void 0 === t3.cursor;
          } }, e2), {}, { request: function(r2) {
            return t2.transporter.read({ method: j, path: p("1/indexes/%s/browse", t2.indexName), data: r2 }, e2);
          } }));
        };
      }, kt = function(t2) {
        return function(e2) {
        ...
        return function(e2) {
          return d(t2.transporter.write({ method: j, path: p("1/indexes/%s/clear", t2.indexName) }, e2), function(e3, r2) {
        ...
        return function(e2) {
          ...
          return a2 && (o2.queryParameters.forwardToReplicas = 1), d(t2.transporter.write({ method: j, path: p("1/indexes/%s/rules/clear", t2.indexName) }, o2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, Et = function(t2) {
        return function(e2) {
          var r2 = e2 || {}, a2 = r2.forwardToReplicas, o2 = y(n(r2, ["forwardToReplicas"]));
          return a2 && (o2.queryParameters.forwardToReplicas = 1), d(t2.transporter.write({ method: j, path: p("1/indexes/%s/synonyms/clear", t2.indexName) }, o2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, At = function(t2) {
        return function(e2, r2) {
          return d(t2.transporter.write({ method: j, path: p("1/indexes/%s/deleteByQuery", t2.indexName), data: e2 }, r2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, Ct = function(t2) {
        return function(e2) {
          return d(t2.transporter.write({ method: I, path: p("1/indexes/%s", t2.indexName) }, e2), function(e3, r2) {
            return de(t2)(e3.taskID, r2);
          });
        };
      }, Ut = function(t2) {
        ...
        return function(e2, r2) {
          ...
          return o2 && (i2.queryParameters.forwardToReplicas = 1), d(t2.transporter.write({ method: I, path: p("1/indexes/%s/rules/%s", t2.indexName, e2) }, i2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, Ft = function(t2) {
        return function(e2, r2) {
          var a2 = r2 || {}, o2 = a2.forwardToReplicas, i2 = y(n(a2, ["forwardToReplicas"]));
          return o2 && (i2.queryParameters.forwardToReplicas = 1), d(t2.transporter.write({ method: I, path: p("1/indexes/%s/synonyms/%s", t2.indexName, e2) }, i2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, Ht = function(t2) {
        return function(e2) {
          return Gt(t2)(e2).then(function() {
            return true;
          }).catch(function(t3) {
            if (404 !== t3.status)
              throw t3;
        ...
        return function(e2, r2, n2) {
          return t2.transporter.read({ method: j, path: p("1/answers/%s/prediction", t2.indexName), data: { query: e2, queryLanguages: r2 }, cacheable: true }, n2);
        };
      }, Bt = function(t2) {
        ...
        return function(e2, r2) {
          return t2.transporter.read({ method: x, path: p("1/indexes/%s/%s", t2.indexName, e2) }, r2);
        };
      }, Wt = function() {
        ...
        return function(e2, r2) {
          return t2.transporter.read({ method: x, path: p("1/indexes/%s/rules/%s", t2.indexName, e2) }, r2);
        };
      }, Gt = function(t2) {
        return function(e2) {
          return t2.transporter.read({ method: x, path: p("1/indexes/%s/settings", t2.indexName), data: { getVersion: 2 } }, e2);
        };
      }, Vt = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: x, path: p("1/indexes/%s/synonyms/%s", t2.indexName, e2) }, r2);
        };
      }, _t = function(t2) {
        return function(e2, r2) {
        ...
        return function(e2, i2) {
          var u2 = i2 || {}, s2 = u2.safe, c2 = u2.autoGenerateObjectIDIfNotExist, f2 = u2.batchSize, l2 = n(u2, ["safe", "autoGenerateObjectIDIfNotExist", "batchSize"]), h2 = function(e3, r2, n2, a2) {
            return d(t2.transporter.write({ method: j, path: p("1/indexes/%s/operation", e3), data: { operation: n2, destination: r2 } }, a2), function(e4, r3) {
              return de(t2)(e4.taskID, r3);
            });
          }, m2 = Math.random().toString(36).substring(7), y2 = "".concat(t2.indexName, "_tmp_").concat(m2), g2 = ee({ appId: t2.appId, transporter: t2.transporter, indexName: y2 }), v2 = [], b2 = h2(t2.indexName, y2, "copy", r(r({}, l2), {}, { scope: ["settings", "synonyms", "rules"] }));
          return v2.push(b2), d((s2 ? b2.wait(l2) : b2).then(function() {
            ...
            var e3 = h2(y2, t2.indexName, "move", l2);
        ...
        return function(e2, r2) {
          ...
          if (u2 === le.UpdateObject) {
            ...
            try {
              for (var l2, h2 = e2[Symbol.iterator](); !(s2 = (l2 = h2.next()).done); s2 = true) {
        ...
        return function(e2, r2) {
          ...
          return o2 && (u2.queryParameters.forwardToReplicas = 1), i2 && (u2.queryParameters.clearExistingRules = 1), d(t2.transporter.write({ method: j, path: p("1/indexes/%s/rules/batch", t2.indexName), data: e2 }, u2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, ae = function(t2) {
        ...
        return function(e2, r2) {
          ...
          return o2 && (s2.queryParameters.forwardToReplicas = 1), (u2 || i2) && (s2.queryParameters.replaceExistingSynonyms = 1), d(t2.transporter.write({ method: j, path: p("1/indexes/%s/synonyms/batch", t2.indexName), data: e2 }, s2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, ie = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: j, path: p("1/indexes/%s/query", t2.indexName), data: { query: e2 }, cacheable: true }, r2);
        };
      }, ue = function(t2) {
        return function(e2, r2, n2) {
          return t2.transporter.read({ method: j, path: p("1/indexes/%s/facets/%s/query", t2.indexName, e2), data: { facetQuery: r2 }, cacheable: true }, n2);
        };
      }, se = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: j, path: p("1/indexes/%s/rules/search", t2.indexName), data: { query: e2 } }, r2);
        };
      }, ce = function(t2) {
        return function(e2, r2) {
          return t2.transporter.read({ method: j, path: p("1/indexes/%s/synonyms/search", t2.indexName), data: { query: e2 } }, r2);
        };
      }, fe = function(t2) {
        return function(e2, r2) {
          var a2 = r2 || {}, o2 = a2.forwardToReplicas, i2 = y(n(a2, ["forwardToReplicas"]));
          return o2 && (i2.queryParameters.forwardToReplicas = 1), d(t2.transporter.write({ method: D, path: p("1/indexes/%s/settings", t2.indexName), data: e2 }, i2), function(e3, r3) {
            return de(t2)(e3.taskID, r3);
          });
        };
      }, de = function(t2) {
          ...
          return f(function(n2) {
            return (/* @__PURE__ */ function(t3) {
              return function(e3, r3) {
                return t3.transporter.read({ method: x, path: p("1/indexes/%s/task/%s", t3.indexName, e3.toString()) }, r3);
              };
      ...
      }, le = { AddObject: "addObject", UpdateObject: "updateObject", PartialUpdateObject: "partialUpdateObject", PartialUpdateObjectNoCreate: "partialUpdateObjectNoCreate", DeleteObject: "deleteObject", DeleteIndex: "delete", ClearIndex: "clear" }, he = { Settings: "settings", Synonyms: "synonyms", Rules: "rules" }, pe = 1, me = 2, ye = 3;
      var ge = function(t2) {
        return function(e2, n2) {
          var a2 = e2.map(function(t3) {
            return r(r({}, t3), {}, { threshold: t3.threshold || 0 });
          });
          return t2.transporter.read({ method: j, path: "1/indexes/*/recommendations", data: { requests: a2 }, cacheable: true }, n2);
        };
      }, ve = function(t2) {
        return function(e2, n2) {
          return ge(t2)(e2.map(function(t3) {
            return r(r({}, t3), {}, { fallbackParameters: {}, model: "bought-together" });
          }), n2);
        };
      }, be = function(t2) {
        return function(e2, n2) {
          return ge(t2)(e2.map(function(t3) {
            return r(r({}, t3), {}, { model: "related-products" });
          }), n2);
        };
      }, Pe = function(t2) {
        return function(e2, n2) {
          var a2 = e2.map(function(t3) {
            return r(r({}, t3), {}, { model: "trending-facets", threshold: t3.threshold || 0 });
          });
          return t2.transporter.read({ method: j, path: "1/indexes/*/recommendations", data: { requests: a2 }, cacheable: true }, n2);
        };
      }, Oe = function(t2) {
        return function(e2, n2) {
          var a2 = e2.map(function(t3) {
            return r(r({}, t3), {}, { model: "trending-items", threshold: t3.threshold || 0 });
          });
          return t2.transporter.read({ method: j, path: "1/indexes/*/recommendations", data: { requests: a2 }, cacheable: true }, n2);
        };
      }, we = function(t2) {
        return function(e2, n2) {
          return ge(t2)(e2.map(function(t3) {
            return r(r({}, t3), {}, { model: "looking-similar" });
          }), n2);
        };
      }, Ie = function(t2) {
        return function(e2, n2) {
          var a2 = e2.map(function(t3) {
            return r(r({}, t3), {}, { model: "recommended-for-you", threshold: t3.threshold || 0 });
          });
          return t2.transporter.read({ method: j, path: "1/indexes/*/recommendations", data: { requests: a2 }, cacheable: true }, n2);
        };
      };
      function xe(t2, e2, n2) {
        var a2, o2 = { appId: t2, apiKey: e2, timeouts: { connect: 1, read: 2, write: 30 }, requester: { send: function(t3) {
          ...
          return pe >= a2 && console.debug(t3, e3), Promise.resolve();
        }, info: function(t3, e3) {
          return me >= a2 && console.info(t3, e3), Promise.resolve();
        }, error: function(t3, e3) {
          return console.error(t3, e3), Promise.resolve();
        } }), responsesCache: s(), requestsCache: s({ serializable: false }), hostsCache: u({ caches: [i({ key: "".concat("4.23.3", "-").concat(t2) }), s()] }), userAgent: T("4.23.3").add({ segment: "Browser" }) }, f2 = r(r({}, o2), n2), d2 = function() {
          return function(t3) {
            return function(t4) {
              var e3 = t4.region || "us", n3 = c(m.WithinHeaders, t4.appId, t4.apiKey), a3 = S(r(r({ hosts: [{ url: "personalization.".concat(e3, ".algolia.com") }] }, t4), {}, { headers: r(r(r({}, n3.headers()), { "content-type": "application/json" }), t4.headers), queryParameters: r(r({}, n3.queryParameters()), t4.queryParameters) }));
              return h({ appId: t4.appId, transporter: a3 }, t4.methods);
        ...
        return function(t3) {
          ...
          return h({ transporter: a3, appId: e3, addAlgoliaAgent: function(t4, e4) {
            a3.userAgent.add({ segment: t4, version: e4 });
          }, clearCache: function() {
            return Promise.all([a3.requestsCache.clear(), a3.responsesCache.clear()]).then(function() {
            });
          } }, t3.methods);
        }(r(r({}, f2), {}, { methods: { search: mt, searchForFacetValues: yt, multipleBatch: ht, multipleGetObjects: pt, multipleQueries: mt, copyIndex: G, copySettings: _, copySynonyms: X, copyRules: V, moveIndex: lt, listIndices: ft, getLogs: nt, listClusters: ct, multipleSearchForFacetValues: yt, getApiKey: tt, addApiKey: K, listApiKeys: st, updateApiKey: xt, deleteApiKey: Z, restoreApiKey: bt, assignUserID: W, assignUserIDs: L, getUserID: ot, searchUserIDs: wt, listUserIDs: dt, getTopUserIDs: at, removeUserID: gt, hasPendingMappings: it, clearDictionaryEntries: Q, deleteDictionaryEntries: $, getDictionarySettings: rt, getAppTask: et, replaceDictionaryEntries: vt, saveDictionaryEntries: Pt, searchDictionaryEntries: Ot, setDictionarySettings: It, waitAppTask: jt, customRequest: Y, initIndex: function(t3) {
          return function(e3) {
            return ut(t3)(e3, { methods: { batch: Dt, delete: Ct, findAnswers: Mt, getObject: Kt, getObjects: Lt, saveObject: te, saveObjects: ee, search: ie, searchForFacetValues: ue, waitTask: de, setSettings: fe, getSettings: Gt, partialUpdateObject: _t, partialUpdateObjects: Xt, deleteObject: Ut, deleteObjects: zt, deleteBy: At, clearObjects: Nt, browseObjects: qt, getObjectPosition: Wt, findObject: Bt, exists: Ht, saveSynonym: ae, saveSynonyms: oe, getSynonym: Vt, searchSynonyms: ce, browseSynonyms: St, deleteSynonym: Ft, clearSynonyms: Et, replaceAllObjects: Yt, replaceAllSynonyms: $t, searchRules: se, getRule: Qt, deleteRule: Jt, saveRule: re, saveRules: ne, replaceAllRules: Zt, browseRules: kt, clearRules: Rt } });
          };
        }, initAnalytics: function() {
          return function(t3) {
            return function(t4) {
              var e3 = t4.region || "us", n3 = c(m.WithinHeaders, t4.appId, t4.apiKey), a3 = S(r(r({ hosts: [{ url: "analytics.".concat(e3, ".algolia.com") }] }, t4), {}, { headers: r(r(r({}, n3.headers()), { "content-type": "application/json" }), t4.headers), queryParameters: r(r({}, n3.queryParameters()), t4.queryParameters) }));
              return h({ appId: t4.appId, transporter: a3 }, t4.methods);
        ...
        }, getRecommendations: ge, getFrequentlyBoughtTogether: ve, getLookingSimilar: we, getRecommendedForYou: Ie, getRelatedProducts: be, getTrendingFacets: Pe, getTrendingItems: Oe } }));
      }
